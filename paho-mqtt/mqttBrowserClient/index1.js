...
connectBtn.click(function () {
  ...
  client.on('message', function (topic, message) {// function for the incomming messages
    // message is Buffer
  ...
  let payload;
  publishBtn.click(function () {// function for the published messages
    let topic = $("#pubTopic");
    payload = $("#payloadPub");
  ...
  subscribeBtn.click(function () {// function to subscribed messages
    let topic = $("#topicSub");
    let parent = $("#subTable");
